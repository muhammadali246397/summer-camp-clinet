            ...
            <Slide direction='right' key={ins._id}>
                <div className=' mb-5 p-2 hover:bg-slate-50'>
                    ...
                    <div className="text-center mt-4 ">
                        ...
                        <div>
                            <button disabled={!disabled} onClick={() => addClass(ins)} className='btn w-full text-lg hover:text-orange-600 mt-4  bg-[#B2AB8C] text-white border-none rounded-none font-bold'>select</button>
                        </div>
